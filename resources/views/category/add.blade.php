...
@section('content')
    ...
    <div class="mt-4 h4">Add Category 
        <a href="{{ url('category') }}" class="btn btn-danger float-end">Back</a>
        <button
            class="btn btn-primary float-end me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
            aria-controls="offcanvasRight">Add Category</button></div>
    <hr>
