$(document).ready(function(){
    ...
    // ROLE HAS PERMISSION VALIDATION
    ...
    //     messages: {
    //         permissions: {
    //             required: "Select atleast one permission",
    //         }
    //     },
    //     highlight: function (element) {
    //         $(element).addClass("validation");
    ...
    // $("#roleHasPermissionForm").validate(rolePermissionValidation);

    // $("#roleHasPermissionForm").on("submit", function (e) {
    //     // if ($("#roleHasPermissionForm").valid()) {
    //         e.preventDefault();
    //         $.ajaxSetup({
    //             headers: {
    //                 "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
    ...
    //             },
    //         });
    //         var formData = new FormData(document.getElementById("roleHasPermissionForm"));
